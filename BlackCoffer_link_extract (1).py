...
list1 = [StopWords_Names]
list2 = [StopWords_Geographic]
list3 = [StopWords_GenericLong]
list4 = [StopWords_Generic]
list5 = [StopWords_DatesandNumbers]
list6 = [StopWords_Currencies]
list7 = [StopWords_Auditor]



concatenated_list = []
stopword_list=concatenated_list
concatenated_list.extend(list1)
concatenated_list.extend(list2)
concatenated_list.extend(list3)
concatenated_list.extend(list4)
concatenated_list.extend(list5)
concatenated_list.extend(list6)
concatenated_list.extend(list7)
#print(stopword_list)
